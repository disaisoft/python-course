...
con sus respectivas cantidades y precios en USD, haciendo uso de listas. 
Luego, imprima los datos de cada moneda una vez que han sido ingresadas por el usuario.
"""
